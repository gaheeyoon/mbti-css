...
import { ResultList } from '../assets/data/resultList';
...
const Result = () => {
  ...
  return ( 
    <div className="container text-center">
      <img id="img" className="rounded-circle mt-30" width="200px" src={`${process.env.PUBLIC_URL}/assets/img/${mbti}.png`} alt="result" /> 
